...
setup(
    ...
    long_description_content_type='text/markdown',  # Optional (see not above)
    ...
    # project.
    author='Aqua Eustoma',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='yjbian92@gmail.com',  # Optional
    ...
    classifiers=[  # Optional
        ...
        'Intended Audience :: Researchers and Developers who are interested in Ensemble Learning',
